...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "2jk9067jt1p041mny1vd7h22wnqv33fx1tdfkpphfa47k0y901g0",
...
const fossilPort: Text = "8081";
const proxyPort: Text = "9000";

const myCommand :Spk.Manifest.Command = (
  argv = ["/sandstorm-http-bridge", .proxyPort, "--", "/fossil-proxy"],
  environ = [
    (key = "PATH", value = "/usr/local/bin:/usr/bin:/bin"),
    # Fossil wants this to operate correctly:
    (key = "USER", value = "grain"),
    (key = "HOME", value = "/var"),

    (key = "REPO_PATH", value = "/var/repo.fossil"),
    (key = "FOSSIL_PORT", value = .fossilPort),
    (key = "PROXY_PORT", value = .proxyPort),
  ]
);
